...
import { FaNodeJs, FaHtml5, FaPython } from "react-icons/fa";
import { 
  SiTailwindcss, 
  SiMongodb, 
  SiNextdotjs, 
  ...
  return (
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div variants={iconVariants(7)} initial="initial" animate="animate" className="rounded-2xl border-2 border-neutral-800 p-4">
          <SiMongodb className="text-7xl text-red-500" />
        </motion.div>
        <motion.div variants={iconVariants(9)} initial="initial" animate="animate" className="rounded-2xl border-2 border-neutral-800 p-4">
      ...
      >
        <motion.div variants={iconVariants(2)} initial="initial" animate="animate" className="rounded-2xl border-2 border-neutral-800 p-4">
